...
const ModalCloseButton = ({ onClose }) => {
    ...
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx(ConfirmCloseAlert.ConfirmCloseAlert, { isOpen: showModal, onClose: () => setShowModal(false), onConfirm: () => {
                    setShowModal(false);
                    onClose();
                } }), jsxRuntime.jsx(react$1.IconButton, { variant: "unstyled", "aria-label": "Close modal", icon: jsxRuntime.jsx(cg.CgClose, {}), color: "white", position: "absolute", transform: "translate(50%, -50%)", right: "14px", top: "20px", onClick: () => setShowModal(true), zIndex: "toast" })] }));
};
