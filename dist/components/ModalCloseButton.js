...
const ModalCloseButton = ({ onClose }) => {
    ...
    return (jsxs(Fragment, { children: [jsx(ConfirmCloseAlert, { isOpen: showModal, onClose: () => setShowModal(false), onConfirm: () => {
                    setShowModal(false);
                    onClose();
                } }), jsx(IconButton, { variant: "unstyled", "aria-label": "Close modal", icon: jsx(CgClose, {}), color: "white", position: "absolute", transform: "translate(50%, -50%)", right: "14px", top: "20px", onClick: () => setShowModal(true), zIndex: "toast" })] }));
};
